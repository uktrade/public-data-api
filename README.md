...
| `AWS_S3_ENDPOINT`       | The URL to the bucket, optionally including a key prefix, and will typically end in a slash. Supports both path and domain-style bucket-access. | `https://my-bucket.s3-eu-west-2.amazonaws.com/`<br>`https://my-bucket.s3-eu-west-2.amazonaws.com/key-prefix/`<br>`https://s3-eu-west-2.amazonaws.com/my-bucket/`<br>`https://s3-eu-west-2.amazonaws.com/my-bucket/key-prefix/`
